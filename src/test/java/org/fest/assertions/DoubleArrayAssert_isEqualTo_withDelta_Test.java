...
public class DoubleArrayAssert_isEqualTo_withDelta_Test {
  ...
  @Test public void should_pass_if_actual_and_expected_are_equal_using_delta() {
    new DoubleArrayAssert(array).isEqualTo(doubleArray(55.00, 4345.0), delta(1.0));
  }

  @Test public void should_pass_if_actual_and_expected_are_exactly_equal() {
    new DoubleArrayAssert(array).isEqualTo(doubleArray(55.03, 4345.91), delta(1.0));
  }

  @Test public void should_pass_if_actual_is_same_as_expected() {
  ...
  @Test public void should_fail_if_expected_is_null() {
    thrown.expectAssertionError("expected:<null> but was:<[55.03, 4345.91]> using delta:<0.1>");
  ...
  @Test public void should_fail_and_display_description_if_expected_is_null() {
    thrown.expectAssertionError("[A Test] expected:<null> but was:<[55.03, 4345.91]> using delta:<0.1>");
    new DoubleArrayAssert(array).as("A Test")
                                .isEqualTo(null, delta(0.1));
  }

  @Test public void should_fail_with_custom_message_if_expected_is_null() {
    thrown.expectAssertionError("My custom message");
    new DoubleArrayAssert(array).overridingErrorMessage("My custom message")
                                .isEqualTo(null, delta(0.1));
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_expected_is_null() {
    thrown.expectAssertionError("My custom message");
    new DoubleArrayAssert(array).as("A Test")
  ...
  @Test public void should_fail_if_arrays_do_not_have_equal_size() {
    thrown.expectAssertionError("expected:<[5323.2]> but was:<[55.03, 4345.91]> using delta:<0.1>");
    new DoubleArrayAssert(array).isEqualTo(doubleArray(5323.2), delta(0.1));
  }

  @Test public void should_fail_and_display_description_if_arrays_do_not_have_equal_size() {
    thrown.expectAssertionError("[A Test] expected:<[5323.2]> but was:<[55.03, 4345.91]> using delta:<0.1>");
    new DoubleArrayAssert(array).as("A Test")
                                .isEqualTo(doubleArray(5323.2), delta(0.1));
  }

  @Test public void should_fail_with_custom_message_if_arrays_do_not_have_equal_size() {
    thrown.expectAssertionError("My custom message");
    new DoubleArrayAssert(array).overridingErrorMessage("My custom message")
                                .isEqualTo(doubleArray(5323.2), delta(0.1));
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_arrays_do_not_have_equal_size() {
    thrown.expectAssertionError("My custom message");
    new DoubleArrayAssert(array).as("A Test")
                                .overridingErrorMessage("My custom message")
                                .isEqualTo(doubleArray(5323.2), delta(0.1));
  ...
  @Test public void should_fail_if_actual_and_expected_are_not_equal() {
    thrown.expectAssertionError("expected:<[55.0, 4345.0]> but was:<[55.03, 4345.91]> using delta:<0.1>");
  ...
  @Test public void should_fail_and_display_description_if_actual_and_expected_are_not_equal() {
    thrown.expectAssertionError("[A Test] expected:<[55.0, 4345.0]> but was:<[55.03, 4345.91]> using delta:<0.1>");
    new DoubleArrayAssert(array).as("A Test")
