...
/**
 * Tests for {@link ShortAssert#isNegative()}.
 *
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
...
public class ShortAssert_isNegative_Test implements NumberAssert_isNegative_TestCase {
  ...
  public void should_fail_and_display_description_if_actual_is_positive() {
    ...
    new ShortAssert(positive).as("A Test").isNegative();
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_positive() {
    ...
    new ShortAssert(positive).overridingErrorMessage("My custom message").isNegative();
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_positive() {
    thrown.expect(AssertionError.class, "My custom message");
    new ShortAssert(positive).as("A Test").overridingErrorMessage("My custom message").isNegative();
  }
  ...
  public void should_fail_and_display_description_if_actual_is_zero() {
    ...
    new ShortAssert(zero).as("A Test").isNegative();
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new ShortAssert(zero).overridingErrorMessage("My custom message").isNegative();
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new ShortAssert(zero).as("A Test").overridingErrorMessage("My custom message").isNegative();
  }
}
