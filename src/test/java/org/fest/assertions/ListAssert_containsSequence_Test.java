...
public class ListAssert_containsSequence_Test {
  ...
  @Test public void should_fail_and_display_description_if_actual_does_not_contain_sequence() {
  ...
  @Test public void should_fail_with_custom_message_if_actual_does_not_contain_sequence() {
    thrown.expectAssertionError("My custom message");
    new ListAssert(list).overridingErrorMessage("My custom message")
                        .containsSequence("Ben");
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_contain_sequence() {
    thrown.expectAssertionError("My custom message");
    new ListAssert(list).as("A Test")
  ...
  @Test public void should_fail_if_actual_does_not_contain_some_elements_in_the_sequence() {
  ...
  @Test public void should_fail_and_display_description_if_actual_does_not_contain_some_elements_in_the_sequence() {
  ...
  @Test public void should_fail_with_custom_message_if_actual_does_not_contain_some_elements_in_the_sequence() {
    thrown.expectAssertionError("My custom message");
    new ListAssert(list).overridingErrorMessage("My custom message")
                        .containsSequence("Anakin", "Ben");
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_contain_some_elements_in_the_sequence() {
    thrown.expectAssertionError("My custom message");
    new ListAssert(list).as("A Test")
                        .overridingErrorMessage("My custom message")
                        .containsSequence("Anakin", "Ben");
