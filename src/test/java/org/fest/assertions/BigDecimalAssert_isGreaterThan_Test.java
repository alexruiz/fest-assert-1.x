...
public class BigDecimalAssert_isGreaterThan_Test implements Assert_isGreaterThan_TestCase {
  ...
  public void should_fail_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "actual value:<8.0> should be greater than:<8.0>");
  ...
  public void should_fail_and_display_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<8.0> should be greater than:<8.0>");
  ...
  public void should_fail_with_custom_message_if_actual_is_equal_to_expected() {
    ...
    new BigDecimalAssert(eight()).overridingErrorMessage("My custom message").isGreaterThan(eight());
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(eight()).as("A Test").overridingErrorMessage("My custom message").isGreaterThan(eight());
  }

  @Override
  @Test
  public void should_fail_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "actual value:<0> should be greater than:<8.0>");
  ...
  public void should_fail_and_display_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<0> should be greater than:<8.0>");
    new BigDecimalAssert(ZERO).as("A Test").isGreaterThan(eight());
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(ZERO).overridingErrorMessage("My custom message").isGreaterThan(eight());
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(ZERO).as("A Test").overridingErrorMessage("My custom message").isGreaterThan(eight());
  }
}
