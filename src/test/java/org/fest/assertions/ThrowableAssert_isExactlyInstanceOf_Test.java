...
public class ThrowableAssert_isExactlyInstanceOf_Test {
  ...
  @Test public void should_pass_if_actual_is_exactly_instance_of_expected() {
  ...
  @Test public void should_fail_if_actual_is_instance_of_expected_but_not_exactly() {
  ...
  @Test public void should_fail_and_display_description_if_actual_is_instance_of_expected_but_not_exactly() {
  ...
  @Test public void should_fail_with_custom_message_if_actual_is_instance_of_expected_but_not_exactly() {
    thrown.expectAssertionError("My custom message");
    new ThrowableAssert(new NullPointerException()).overridingErrorMessage("My custom message")
                                                   .isExactlyInstanceOf(Exception.class);
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_actual_is_instance_of_expected_but_not_exactly() {
    thrown.expectAssertionError("My custom message");
    new ThrowableAssert(new NullPointerException()).as("A Test")
  ...
  @Test public void should_fail_if_actual_is_not_exactly_instance_of_expected() {
  ...
  @Test public void should_fail_and_display_description_if_actual_is_not_exactly_instance_of_expected() {
  ...
  @Test public void should_fail_with_custom_message_if_actual_is_not_exactly_instance_of_expected() {
    thrown.expectAssertionError("My custom message");
    new ThrowableAssert(new Exception()).overridingErrorMessage("My custom message")
                                        .isExactlyInstanceOf(NullPointerException.class);
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_actual_is_not_exactly_instance_of_expected() {
    thrown.expectAssertionError("My custom message");
    new ThrowableAssert(new Exception()).as("A Test")
                                        .overridingErrorMessage("My custom message")
                                        .isExactlyInstanceOf(NullPointerException.class);
