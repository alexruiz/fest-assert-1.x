...
public class DoubleArrayAssert_contains_Test implements GroupAssert_contains_TestCase {
  ...
  @Test public void should_fail_if_actual_does_not_contain_given_values() {
    thrown.expectAssertionError("<[55.03, 4345.91]> does not contain element(s):<[6.8]>");
  ...
  @Test public void should_fail_and_display_description_if_actual_does_not_contain_given_values() {
    thrown.expectAssertionError("[A Test] <[55.03, 4345.91]> does not contain element(s):<[6.8]>");
    new DoubleArrayAssert(array).as("A Test")
                                .contains(6.8);
  }
