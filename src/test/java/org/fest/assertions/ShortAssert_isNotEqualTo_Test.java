...
/**
 * Tests for {@link ShortAssert#isNotEqualTo(short)}.
 *
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
...
public class ShortAssert_isNotEqualTo_Test implements Assert_isNotEqualTo_TestCase {
  ...
  public void should_fail_if_actual_and_expected_are_equal() {
    thrown.expect(AssertionError.class, "actual value:<6> should not be equal to:<6>");
  ...
  public void should_fail_and_display_description_if_actual_and_expected_are_equal() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<6> should not be equal to:<6>");
