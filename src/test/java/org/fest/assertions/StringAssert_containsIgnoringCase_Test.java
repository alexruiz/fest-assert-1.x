...
public class StringAssert_containsIgnoringCase_Test {
  ...
  @Test public void should_fail_if_actual_String_does_not_contain_given_String() {
    thrown.expectAssertionError("<'hello'> does not contain <'world'>");
  ...
  @Test public void should_throw_error_if_given_String_is_null() {
    thrown.expectNullPointerException("The given String should not be null");
    new StringAssert("hello").containsIgnoringCase(null);
  }

  @Test public void should_pass_if_actual_String_contains_given_String_with_same_case() {
    new StringAssert("hello").containsIgnoringCase("hello");
  }

  @Test public void should_pass_if_actual_String_contains_given_String_with_different_case() {
    new StringAssert("hello").containsIgnoringCase("HELLO");
  }
}