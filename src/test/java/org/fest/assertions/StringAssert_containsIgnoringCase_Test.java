...
/**
 * Tests for {@link StringAssert#containsIgnoringCase(String)}.
 *
 * @author Yvonne Wang
 */
public class StringAssert_containsIgnoringCase_Test {
  ...
  public void should_fail_if_actual_String_does_not_contain_given_String() {
    thrown.expect(AssertionError.class, "<'hello'> does not contain <'world'>");
  ...
  public void should_fail_with_custom_message_if_actual_does_not_contain_given_String() {
    ...
    new StringAssert("hello").overridingErrorMessage("My custom message").containsIgnoringCase("world");
  }

  @Test
  public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_contain_given_String() {
    thrown.expect(AssertionError.class, "My custom message");
    new StringAssert("hello").as("A Test").overridingErrorMessage("My custom message").containsIgnoringCase("world");
  }
