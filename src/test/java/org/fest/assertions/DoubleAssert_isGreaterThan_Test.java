...
/**
 * Test for {@link DoubleAssert#isGreaterThan(double)}.
 *
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
...
public class DoubleAssert_isGreaterThan_Test implements Assert_isGreaterThan_TestCase {
  ...
  public void should_fail_with_custom_message_if_actual_is_equal_to_expected() {
    ...
    new DoubleAssert(8.68).overridingErrorMessage("My custom message").isGreaterThan(8.68);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(8.68).as("A Test").overridingErrorMessage("My custom message").isGreaterThan(8.68);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(8.68).overridingErrorMessage("My custom message").isGreaterThan(8.88);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(8.68).as("A Test").overridingErrorMessage("My custom message").isGreaterThan(8.88);
  }
}