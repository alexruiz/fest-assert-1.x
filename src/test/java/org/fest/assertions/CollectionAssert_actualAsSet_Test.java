...
/**
 * Tests for <code>{@link CollectionAssert#actualAsSet()}</code>
 *
 * @author Alex Ruiz
 */
public class CollectionAssert_actualAsSet_Test {
  ...
  @Test public void should_return_Set_with_contents_in_actual() {
    ...
    assertEquals(assertions.actual, new ArrayList<Object>(set));
  }
}
