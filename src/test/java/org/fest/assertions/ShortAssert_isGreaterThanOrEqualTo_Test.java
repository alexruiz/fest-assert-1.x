...
public class ShortAssert_isGreaterThanOrEqualTo_Test implements Assert_isGreaterThanOrEqualTo_TestCase {
  ...
  public void should_fail_and_display_description_if_actual_is_less_than_expected() {
    ...
    new ShortAssert(actual).as("A Test").isGreaterThanOrEqualTo(greaterThanActual);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_less_than_expected() {
    ...
    new ShortAssert(actual).overridingErrorMessage("My custom message").isGreaterThanOrEqualTo(greaterThanActual);
  }
