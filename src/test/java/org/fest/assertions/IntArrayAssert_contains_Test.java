...
/**
 * Tests for {@link IntArrayAssert#contains(int...)}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class IntArrayAssert_contains_Test implements GroupAssert_contains_TestCase {
  ...
  public void should_pass_if_actual_contains_given_value() {
    new IntArrayAssert(array).contains(6);
  }

  @Override
  @Test
  public void should_pass_if_actual_contains_given_values() {
    new IntArrayAssert(array).contains(6, 8);
  }
  ...
  public void should_fail_and_display_description_if_actual_is_null() {
    ...
    new IntArrayAssert(null).as("A Test").contains(6, 8);
  }
  ...
  public void should_throw_error_if_expected_is_null() {
    ...
    new IntArrayAssert(array).contains(null);
  }
  ...
  public void should_fail_if_actual_does_not_contain_given_values() {
    ...
    new IntArrayAssert(array).contains(10);
  }
  ...
  public void should_fail_and_display_description_if_actual_does_not_contain_given_values() {
    ...
    new IntArrayAssert(array).as("A Test").contains(10);
  }
  ...
  public void should_fail_with_custom_message_if_actual_does_not_contain_given_values() {
    ...
    new IntArrayAssert(array).overridingErrorMessage("My custom message").contains(10);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_contain_given_values() {
    thrown.expect(AssertionError.class, "My custom message");
    new IntArrayAssert(array).as("A Test").overridingErrorMessage("My custom message").contains(10);
  }
}
