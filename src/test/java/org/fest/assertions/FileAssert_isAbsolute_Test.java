...
/**
 * Tests for {@link FileAssert#isAbsolute()}.
 * 
 * @author David DIDIER
 * @author Yvonne Wang
 * @author Alex Ruiz
...
public class FileAssert_isAbsolute_Test extends FileAssert_TestCase {
  ...
  public void should_fail_if_actual_is_not_absolute() {
    thrown.expect(AssertionError.class, "file:<c:\\f.txt> should be an absolute path");
    new FileAssert(file).isAbsolute();
  }

  @Test
  public void should_fail_and_display_description_if_actual_is_not_absolute() {
    thrown.expect(AssertionError.class, "[A Test] file:<c:\\f.txt> should be an absolute path");
  ...
  public void should_fail_with_custom_message_if_actual_is_not_absolute() {
    ...
    new FileAssert(file).overridingErrorMessage("My custom message").isAbsolute();
  }

  @Test
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_not_absolute() {
    thrown.expect(AssertionError.class, "My custom message");
    new FileAssert(file).as("A Test").overridingErrorMessage("My custom message").isAbsolute();
  }
}
