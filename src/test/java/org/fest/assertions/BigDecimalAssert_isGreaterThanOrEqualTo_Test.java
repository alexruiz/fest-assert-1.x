...
public class BigDecimalAssert_isGreaterThanOrEqualTo_Test implements Assert_isGreaterThanOrEqualTo_TestCase {
  ...
  public void should_fail_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "actual value:<0> should be greater than or equal to:<8.0>");
  ...
  public void should_fail_and_display_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<0> should be greater than or equal to:<8.0>");
    new BigDecimalAssert(ZERO).as("A Test").isGreaterThanOrEqualTo(eight());
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_less_than_expected() {
    ...
    new BigDecimalAssert(ZERO).overridingErrorMessage("My custom message").isGreaterThanOrEqualTo(eight());
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(ZERO).as("A Test").overridingErrorMessage("My custom message").isGreaterThanOrEqualTo(eight());
  }
}
