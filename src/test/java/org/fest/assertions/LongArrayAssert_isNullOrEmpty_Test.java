 ...
 * @author Alex Ruiz
 */
public class LongArrayAssert_isNullOrEmpty_Test implements GroupAssert_isNullOrEmpty_TestCase {
  ...
  public void should_pass_if_actual_is_empty() {
    new LongArrayAssert(emptyLongArray()).isNullOrEmpty();
  }
  ...
  public void should_fail_if_actual_has_content() {
    expectAssertionError("expecting null or empty, but was:<[8]>").on(new CodeToTest() {
      public void run() {
        new LongArrayAssert(array).isNullOrEmpty();
      }
    });
  }
