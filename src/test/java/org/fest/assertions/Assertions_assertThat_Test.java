...
public class Assertions_assertThat_Test {
  ...
  @Test public void should_return_BigDecimalAssert_if_argument_is_BigDecimal() {
    assertObjectIsInstanceOfType(Assertions.assertThat(new BigDecimal("8")), BigDecimalAssert.class);
  }

  @Test public void should_return_BooleanArrayAssert_if_argument_is_array_of_boolean() {
    boolean[] booleans = new boolean[] { false };
    assertObjectIsInstanceOfType(Assertions.assertThat(booleans), BooleanArrayAssert.class);
  }

  @Test public void should_return_BooleanAssert_if_argument_is_boolean() {
  ...
  @Test public void should_return_ByteArrayAssert_if_argument_is_array_of_byte() {
    byte[] bytes = new byte[] { 0 };
    assertObjectIsInstanceOfType(Assertions.assertThat(bytes), ByteArrayAssert.class);
  }

  @Test public void should_return_ByteAssert_if_argument_is_byte() {
    byte b = 0;
  ...
  @Test public void should_return_CharArrayAssert_if_argument_is_array_of_char() {
    char[] chars = new char[] { 0 };
    assertObjectIsInstanceOfType(Assertions.assertThat(chars), CharArrayAssert.class);
  }

  @Test public void should_return_CharAssert_if_argument_is_char() {
    assertObjectIsInstanceOfType(Assertions.assertThat('a'), CharAssert.class);
  }

  @Test public void should_return_CharAssert_if_argument_is_Character() {
    assertObjectIsInstanceOfType(Assertions.assertThat(new Character('a')), CharAssert.class);
  }

  @Test public void should_return_CollectionAssert_if_argument_is_Collection() {
    assertObjectIsInstanceOfType(Assertions.assertThat(new HashSet<Object>()), CollectionAssert.class);
  }

  @Test public void should_return_ListAssert_if_argument_is_List() {
  ...
  @Test public void should_return_DoubleAssert_if_argument_is_double() {
  ...
  @Test public void should_return_FileAssert_if_argument_is_File() {
    assertObjectIsInstanceOfType(Assertions.assertThat(Files.temporaryFolder()), FileAssert.class);
  }

  @Test public void should_return_FloatArrayAssert_if_argument_is_array_of_float() {
    float[] floats = new float[] { 0f };
    assertObjectIsInstanceOfType(Assertions.assertThat(floats), FloatArrayAssert.class);
  }

  @Test public void should_return_FloatAssert_if_argument_is_float() {
  ...
  @Test public void should_always_return_given_AssertExtension() {
    AssertExtension extension = new AssertExtension() {};
    assertSame(extension, Assertions.assertThat(extension));
  }

  @Test public void should_return_ImageAssert_if_argument_is_BufferedImage() {
  ...
  @Test public void should_return_IntArrayAssert_if_argument_is_array_of_int() {
    int[] ints = new int[] { 0 };
    assertObjectIsInstanceOfType(Assertions.assertThat(ints), IntArrayAssert.class);
  }

  @Test public void should_return_IntAssert_if_argument_is_int() {
    assertObjectIsInstanceOfType(Assertions.assertThat(8), IntAssert.class);
  }

  @Test public void should_return_IntAssert_if_argument_is_Integer() {
    assertObjectIsInstanceOfType(Assertions.assertThat(new Integer(8)), IntAssert.class);
  }

  @Test public void should_return_LongArrayAssert_if_argument_is_array_of_long() {
    long[] longs = new long[] { 0 };
    assertObjectIsInstanceOfType(Assertions.assertThat(longs), LongArrayAssert.class);
  }

  @Test public void should_return_LongAssert_if_argument_is_long() {
  ...
  @Test public void should_return_StringAssert_if_argument_is_String() {
    assertObjectIsInstanceOfType(Assertions.assertThat(""), StringAssert.class);
  }

  @Test public void should_return_ThrowableAssert_if_argument_is_Throwable() {
