...
public class StringAssert_startsWith_Test {
  ...
  public void should_fail_if_actual_does_not_start_with_given_String() {
    thrown.expect(AssertionError.class, "<'Luke'> should start with:<'uke'>");
    new StringAssert("Luke").startsWith("uke");
  }

  @Test
  public void should_fail_and_display_description_if_actual_does_not_start_with_given_String() {
    thrown.expect(AssertionError.class, "[A Test] <'Luke'> should start with:<'uke'>");
  ...
  public void should_fail_with_custom_message_if_actual_does_not_start_with_given_String() {
    ...
    new StringAssert("Luke").overridingErrorMessage("My custom message").startsWith("uke");
  }

  @Test
  public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_start_with_given_String() {
    thrown.expect(AssertionError.class, "My custom message");
    new StringAssert("Luke").as("A Test").overridingErrorMessage("My custom message").startsWith("uke");
  }
}
