...
/**
 * Tests for {@link ShortArrayAssert#excludes(short...)}.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class ShortArrayAssert_excludes_Test implements GroupAssert_excludes_TestCase {
  ...
  public void should_fail_and_display_description_if_actual_is_null() {
    ...
    new ShortArrayAssert(null).as("A Test").excludes(shortArray(8, 6));
  }
  ...
  public void should_fail_and_display_description_if_actual_contains_given_values() {
    ...
    new ShortArrayAssert(array).as("A Test").excludes(shortArray(8));
  }
  ...
  public void should_fail_with_custom_message_if_actual_contains_given_values() {
    ...
    new ShortArrayAssert(array).overridingErrorMessage("My custom message").excludes(shortArray(8));
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_contains_given_values() {
    thrown.expect(AssertionError.class, "My custom message");
    new ShortArrayAssert(array).as("A Test").overridingErrorMessage("My custom message").excludes(shortArray(8));
  }
}