...
/**
 * Tests for {@link StringAssert#contains(String)}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
...
public class StringAssert_contains_Test {
  ...
  public void should_fail_if_actual_does_not_contain_given_String() {
    thrown.expect(AssertionError.class, "<'Luke'> should contain the String:<'Yoda'>");
    new StringAssert("Luke").contains("Yoda");
  }

  @Test
  public void should_fail_and_display_description_if_actual_does_not_contain_given_String() {
    thrown.expect(AssertionError.class, "[A Test] <'Luke'> should contain the String:<'Yoda'>");
  ...
  public void should_fail_with_custom_message_if_actual_does_not_contain_given_String() {
    ...
    new StringAssert("Luke").overridingErrorMessage("My custom message").contains("Yoda");
  }

  @Test
  public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_contain_given_String() {
    thrown.expect(AssertionError.class, "My custom message");
    new StringAssert("Luke").as("A Test").overridingErrorMessage("My custom message").contains("Yoda");
  }
}
