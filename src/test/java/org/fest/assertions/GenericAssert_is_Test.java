...
/**
 * Tests for {@link GenericAssert#is(Condition)}.
 * 
 * @author Ansgar Konermann
 * @author Alex Ruiz
 */
public class GenericAssert_is_Test implements GenericAssert_satisfies_orAlias_TestCase {
  @Rule
  ...
  public final void should_pass_if_condition_is_satisfied() {
    new TestAssert("Hello").is(notNull);
  }
  ...
  public final void should_fail_if_condition_is_not_satisfied() {
    thrown.expect(AssertionError.class, "actual value:<null> should be:<NotNull>");
  ...
  public final void should_fail_and_display_description_if_condition_is_not_satisfied() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<null> should be:<NotNull>");
    assertions.as("A Test").is(notNull);
  }

  @Override
  @Test
  public final void should_fail_and_display_description_of_condition_if_condition_is_not_satisfied() {
    thrown.expect(AssertionError.class, "actual value:<null> should be:<non-null>");
  ...
  public final void should_fail_and_display_descriptions_of_assertion_and_condition_if_condition_is_not_satisfied() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<null> should be:<non-null>");
    assertions.as("A Test").is(notNull.as("non-null"));
  }
  ...
  public final void should_fail_with_custom_message_if_condition_is_not_satisfied() {
    ...
    assertions.overridingErrorMessage("My custom message").is(notNull);
  }
  ...
  public final void should_fail_with_custom_message_ignoring_description_of_condition_if_condition_is_not_satisfied() {
    thrown.expect(AssertionError.class, "My custom message");
    assertions.overridingErrorMessage("My custom message").is(notNull.as("non-null"));
  }
  ...
  public final void should_fail_with_custom_message_ignoring_description_if_condition_is_not_satisfied() {
    thrown.expect(AssertionError.class, "My custom message");
    assertions.as("A Test").overridingErrorMessage("My custom message").is(notNull);
  }
}