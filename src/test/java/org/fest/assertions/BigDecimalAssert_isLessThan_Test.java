...
public class BigDecimalAssert_isLessThan_Test implements Assert_isLessThan_TestCase {
  ...
  public void should_fail_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "actual value:<8.0> should be less than:<8.0>");
  ...
  public void should_fail_and_display_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<8.0> should be less than:<8.0>");
  ...
  public void should_fail_with_custom_message_if_actual_is_equal_to_expected() {
    ...
    new BigDecimalAssert(eight()).overridingErrorMessage("My custom message").isLessThan(eight());
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(eight()).as("A Test").overridingErrorMessage("My custom message").isLessThan(eight());
  }
  ...
  public void should_fail_and_display_description_if_actual_is_greater_than_expected() {
    ...
    new BigDecimalAssert(eight()).as("A Test").isLessThan(ZERO);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_greater_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(eight()).overridingErrorMessage("My custom message").isLessThan(ZERO);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_greater_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(eight()).as("A Test").overridingErrorMessage("My custom message").isLessThan(ZERO);
  }
}
