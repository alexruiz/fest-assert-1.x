...
/**
 * Tests for {@link CharArrayAssert#containsOnly(char...)}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class CharArrayAssert_containsOnly_Test implements GroupAssert_containsOnly_TestCase {
  ...
  public void should_fail_and_display_description_if_actual_is_null() {
    ...
    new CharArrayAssert(null).as("A Test").containsOnly(charArray('c', 'd'));
  }
  ...
  public void should_fail_if_actual_is_empty_and_expecting_at_least_one_element() {
    thrown.expect(AssertionError.class, "<[]> does not contain element(s):<[c, d]>");
  ...
  public void should_fail_and_display_description_if_actual_is_empty_and_expecting_at_least_one_element() {
    thrown.expect(AssertionError.class, "[A Test] <[]> does not contain element(s):<[c, d]>");
    new CharArrayAssert(emptyCharArray()).as("A Test").containsOnly(charArray('c', 'd'));
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_empty_and_expecting_at_least_one_element() {
    ...
    new CharArrayAssert(emptyCharArray()).overridingErrorMessage("My custom message").containsOnly(charArray('c', 'd'));
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_empty_and_expecting_at_least_one_element() {
    thrown.expect(AssertionError.class, "My custom message");
    new CharArrayAssert(emptyCharArray()).as("A Test").overridingErrorMessage("My custom message")
  ...
  public void should_fail_if_actual_contains_unexpected_values() {
    thrown.expect(AssertionError.class, "unexpected element(s):<[b]> in <[a, b]>");
  ...
  public void should_fail_and_display_description_if_actual_contains_unexpected_values() {
    thrown.expect(AssertionError.class, "[A Test] unexpected element(s):<[b]> in <[a, b]>");
    new CharArrayAssert('a', 'b').as("A Test").containsOnly(charArray('a'));
  }
  ...
  public void should_fail_with_custom_message_if_actual_contains_unexpected_values() {
    thrown.expect(AssertionError.class, "My custom message");
    new CharArrayAssert('a', 'b').overridingErrorMessage("My custom message").containsOnly(charArray('a'));
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_contains_unexpected_values() {
    thrown.expect(AssertionError.class, "My custom message");
    new CharArrayAssert('a', 'b').as("A Test").overridingErrorMessage("My custom message").containsOnly(charArray('a'));
  }

  @Override
  @Test
  public void should_fail_if_actual_does_not_contain_all_the_expected_values() {
    thrown.expect(AssertionError.class, "<[a, b]> does not contain element(s):<[c]>");
  ...
  public void should_fail_and_display_description_if_actual_does_not_contain_all_the_expected_values() {
    thrown.expect(AssertionError.class, "[A Test] <[a, b]> does not contain element(s):<[c]>");
    new CharArrayAssert('a', 'b').as("A Test").containsOnly(charArray('c'));
  }
  ...
  public void should_fail_with_custom_message_if_actual_does_not_contain_all_the_expected_values() {
    thrown.expect(AssertionError.class, "My custom message");
    new CharArrayAssert('a', 'b').overridingErrorMessage("My custom message").containsOnly(charArray('c'));
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_contain_all_the_expected_values() {
    thrown.expect(AssertionError.class, "My custom message");
    new CharArrayAssert('a', 'b').as("A Test").overridingErrorMessage("My custom message").containsOnly(charArray('c'));
  }
}
