...
/**
 * Tests for {@link IntAssert#isPositive()}.
 *
 * @author Yvonne Wang
 * @author David DIDIER
 */
public class IntAssert_isPositive_Test implements NumberAssert_isPositive_TestCase {
  ...
  public void should_fail_and_display_description_if_actual_is_negative() {
    ...
    new IntAssert(-2).as("A Test").isPositive();
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_negative() {
    ...
    new IntAssert(-2).overridingErrorMessage("My custom message").isPositive();
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_negative() {
    thrown.expect(AssertionError.class, "My custom message");
    new IntAssert(-2).as("A Test").overridingErrorMessage("My custom message").isPositive();
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new IntAssert(0).overridingErrorMessage("My custom message").isPositive();
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new IntAssert(0).as("A Test").overridingErrorMessage("My custom message").isPositive();
  }
}