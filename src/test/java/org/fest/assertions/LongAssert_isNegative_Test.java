...
/**
 * Tests for {@link LongAssert#isNegative()}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 */
public class LongAssert_isNegative_Test implements NumberAssert_isNegative_TestCase {
  ...
  public void should_fail_with_custom_message_if_actual_is_positive() {
    ...
    new LongAssert(6).overridingErrorMessage("My custom message").isNegative();
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_positive() {
    thrown.expect(AssertionError.class, "My custom message");
    new LongAssert(6).as("A Test").overridingErrorMessage("My custom message").isNegative();
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new LongAssert(0).overridingErrorMessage("My custom message").isNegative();
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new LongAssert(0).as("A Test").overridingErrorMessage("My custom message").isNegative();
  }
}