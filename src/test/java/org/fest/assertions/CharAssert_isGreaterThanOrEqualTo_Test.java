...
public class CharAssert_isGreaterThanOrEqualTo_Test implements Assert_isGreaterThanOrEqualTo_TestCase {
  ...
  @Test public void should_fail_if_actual_is_less_than_expected() {
    thrown.expectAssertionError("actual value:<A> should be greater than or equal to:<a>");
    new CharAssert('A').isGreaterThanOrEqualTo('a');
  }

  @Test public void should_fail_and_display_description_if_actual_is_less_than_expected() {
    thrown.expectAssertionError("[A Test] actual value:<A> should be greater than or equal to:<a>");
