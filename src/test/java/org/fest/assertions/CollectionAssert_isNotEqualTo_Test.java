 ...
 * @author Alex Ruiz
 */
public class CollectionAssert_isNotEqualTo_Test extends
    GenericAssert_isNotEqualTo_TestCase<CollectionAssert, Collection<?>> {
  ...
  @Override protected Collection<?> notEqualValue() {
    return unequalValue;
  }
}
