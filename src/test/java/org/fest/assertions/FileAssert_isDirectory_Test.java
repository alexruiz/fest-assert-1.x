...
public class FileAssert_isDirectory_Test extends FileAssert_TestCase {
  ...
  @Test public void should_fail_if_actual_is_not_directory() {
    thrown.expectAssertionError("file:<c:\\f.txt> should be a directory");
    new FileAssert(file).isDirectory();
  }

  @Test public void should_fail_and_display_description_if_actual_is_not_directory() {
    thrown.expectAssertionError("[A Test] file:<c:\\f.txt> should be a directory");
    new FileAssert(file).as("A Test")
                        .isDirectory();
  }

  @Test public void should_fail_with_custom_message_if_actual_is_not_directory() {
    thrown.expectAssertionError("My custom message");
    new FileAssert(file).overridingErrorMessage("My custom message")
                        .isDirectory();
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_actual_is_not_directory() {
    thrown.expectAssertionError("My custom message");
    new FileAssert(file).as("A Test")
