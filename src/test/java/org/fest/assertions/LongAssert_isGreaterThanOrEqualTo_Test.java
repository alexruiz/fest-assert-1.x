...
/**
 * Tests for {@link LongAssert#isGreaterThanOrEqualTo(long)}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 */
public class LongAssert_isGreaterThanOrEqualTo_Test implements Assert_isGreaterThanOrEqualTo_TestCase {
  ...
  public void should_fail_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "actual value:<6L> should be greater than or equal to:<8L>");
  ...
  public void should_fail_and_display_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<6L> should be greater than or equal to:<8L>");
  ...
  public void should_fail_with_custom_message_if_actual_is_less_than_expected() {
    ...
    new LongAssert(6).overridingErrorMessage("My custom message").isGreaterThanOrEqualTo(8);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new LongAssert(6).as("A Test").overridingErrorMessage("My custom message").isGreaterThanOrEqualTo(8);
  }
}
