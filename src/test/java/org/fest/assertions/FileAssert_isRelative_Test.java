...
/**
 * Tests for {@link FileAssert#isRelative()}.
 * 
 * @author David DIDIER
 * @author Yvonne Wang
 * @author Alex Ruiz
...
public class FileAssert_isRelative_Test extends FileAssert_TestCase {
  ...
  public void should_fail_if_actual_is_not_relative() {
    ...
    thrown.expect(AssertionError.class, "file:<c:\\f.txt> should be a relative path");
    new FileAssert(file).isRelative();
  }

  @Test
  public void should_fail_and_display_description_if_actual_is_not_relative() {
    file.ensureIsAbsolute();
    thrown.expect(AssertionError.class, "[A Test] file:<c:\\f.txt> should be a relative path");
  ...
  public void should_fail_with_custom_message_if_actual_is_not_relative() {
    ...
    new FileAssert(file).overridingErrorMessage("My custom message").isRelative();
  }

  @Test
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_not_relative() {
    file.ensureIsAbsolute();
    thrown.expect(AssertionError.class, "My custom message");
    new FileAssert(file).as("A Test").overridingErrorMessage("My custom message").isRelative();
  }
}