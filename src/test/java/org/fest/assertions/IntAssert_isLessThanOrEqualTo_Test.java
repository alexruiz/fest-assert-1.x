...
/**
 * Tests for {@link IntAssert#isLessThanOrEqualTo(int)}.
 *
 * @author Yvonne Wang
 * @author David DIDIER
 */
public class IntAssert_isLessThanOrEqualTo_Test implements Assert_isLessThanOrEqualTo_Test {
  @Rule
  ...
  public void should_pass_if_actual_is_less_than_expected() {
    new IntAssert(6).isLessThanOrEqualTo(8);
  }

  @Override
  @Test
  public void should_pass_if_actual_is_equal_to_expected() {
    new IntAssert(6).isLessThanOrEqualTo(6);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_greater_than_expected() {
    ...
    new IntAssert(8).overridingErrorMessage("My custom message").isLessThanOrEqualTo(6);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_greater_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new IntAssert(8).as("A Test").overridingErrorMessage("My custom message").isLessThanOrEqualTo(6);
  }
}