...
/**
 * Test case for implementations of <code>isEqualTo</code> for objects and primitives.
 *
 * @author Alex Ruiz
 */
public interface Assert_isEqualTo_TestCase {

  void should_pass_if_actual_and_expected_are_equal();
