...
/**
 * Tests for {@link IntAssert#isGreaterThan(int)}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 */
public class IntAssert_isGreaterThan_Test implements Assert_isGreaterThan_TestCase {
  @Rule
  ...
  public void should_pass_if_actual_is_greater_than_expected() {
    new IntAssert(6).isGreaterThan(2);
  }
  ...
  public void should_fail_if_actual_is_equal_to_expected() {
    ...
    new IntAssert(6).isGreaterThan(6);
  }
  ...
  public void should_fail_and_display_description_if_actual_is_equal_to_expected() {
    ...
    new IntAssert(6).as("A Test").isGreaterThan(6);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_equal_to_expected() {
    ...
    new IntAssert(6).overridingErrorMessage("My custom message").isGreaterThan(6);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new IntAssert(6).as("A Test").overridingErrorMessage("My custom message").isGreaterThan(6);
  }
  ...
  public void should_fail_if_actual_is_less_than_expected() {
    ...
    new IntAssert(6).isGreaterThan(10);
  }
  ...
  public void should_fail_and_display_description_if_actual_is_less_than_expected() {
    ...
    new IntAssert(6).as("A Test").isGreaterThan(10);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new IntAssert(6).overridingErrorMessage("My custom message").isGreaterThan(10);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new IntAssert(6).as("A Test").overridingErrorMessage("My custom message").isGreaterThan(10);
  }
}