...
/**
 * Test for {@link DoubleAssert#isLessThan(double)}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
...
public class DoubleAssert_isLessThan_Test implements Assert_isLessThan_TestCase {
  ...
  public void should_fail_with_custom_message_if_actual_is_equal_to_expected() {
    ...
    new DoubleAssert(6.68).overridingErrorMessage("My custom message").isLessThan(6.68);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(6.68).as("A Test").overridingErrorMessage("My custom message").isLessThan(6.68);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_greater_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(6.88).overridingErrorMessage("My custom message").isLessThan(6.68);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_greater_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(6.88).as("A Test").overridingErrorMessage("My custom message").isLessThan(6.68);
  }
}
