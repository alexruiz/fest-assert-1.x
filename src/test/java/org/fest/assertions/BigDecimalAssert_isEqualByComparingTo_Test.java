...
public class BigDecimalAssert_isEqualByComparingTo_Test {
  ...
  public void should_fail_and_display_description_if_actual_is_null() {
    ...
    new BigDecimalAssert(null).as("A Test").isEqualByComparingTo(actual);
  }

  @Test
  public void should_fail_if_values_are_not_equal() {
    thrown.expect(AssertionError.class, notEqual(actual, other));
  ...
  public void should_fail_and_display_description_if_values_are_not_equal() {
    thrown.expect(AssertionError.class, notEqual("A Test", actual, other));
    new BigDecimalAssert(actual).as("A Test").isEqualByComparingTo(other);
  }

  @Test
  public void should_fail_with_custom_message_if_values_are_not_equal() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(actual).overridingErrorMessage("My custom message").isEqualByComparingTo(other);
  }

  @Test
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new BigDecimalAssert(actual).as("A Test").overridingErrorMessage("My custom message").isEqualByComparingTo(other);
  }
}
