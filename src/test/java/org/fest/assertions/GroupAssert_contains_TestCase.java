...
public interface GroupAssert_contains_TestCase {
  ...
  void should_fail_if_actual_does_not_contain_given_values();

  void should_fail_and_display_description_of_assertion_if_actual_does_not_contain_given_values();

  void should_fail_with_custom_message_if_actual_does_not_contain_given_values();

  void should_fail_with_custom_message_ignoring_description_of_assertion_if_actual_does_not_contain_given_values();
}