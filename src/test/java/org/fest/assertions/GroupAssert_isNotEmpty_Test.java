...
/**
 * Tests for {@link GroupAssert#isNotEmpty()}.
 *
 * @author Alex Ruiz
 */
public final class GroupAssert_isNotEmpty_Test {
  ...
  public final void should_pass_if_actual_is_not_empty() {
    new TestObjectGroupAssert(newArrayList("Hello")).isNotEmpty();
  }
  ...
  public final void should_fail_and_display_description_if_actual_is_null() {
    ...
    new TestObjectGroupAssert(null).as("A Test").isNotEmpty();
  }
  ...
  @Test
  public final void should_fail_and_display_description_if_actual_is_empty() {
    thrown.expect(AssertionError.class, "[A Test] expecting non-empty, but it was empty");
    assertions.as("A Test").isNotEmpty();
  }

  @Test
  public final void should_fail_with_custom_message_if_actual_is_empty() {
    thrown.expect(AssertionError.class, "My custom message");
    assertions.overridingErrorMessage("My custom message").isNotEmpty();
  }

  @Test
  public final void should_fail_with_custom_message_ignoring_description_if_actual_is_empty() {
    thrown.expect(AssertionError.class, "My custom message");
    assertions.as("A Test").overridingErrorMessage("My custom message").isNotEmpty();
  }
}