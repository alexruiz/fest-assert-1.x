...
public class StringAssert_doesNotContain_Test {
  ...
  public void should_fail_if_actual_String_contains_given_text() {
    thrown.expect(AssertionError.class, "<'hello'> should not contain <'he'>");
    new StringAssert("hello").doesNotContain("he");
  }

  @Test
  public void should_fail_and_display_description_if_actual_String_contains_given_text() {
    thrown.expect(AssertionError.class, "[A Test] <'hello'> should not contain <'he'>");
  ...
  public void should_fail_with_custom_message_if_actual_String_contains_given_text() {
    ...
    new StringAssert("hello").overridingErrorMessage("My custom message").doesNotContain("he");
  }

  @Test
  public void should_fail_with_custom_message_ignoring_description_if_actual_String_contains_given_text() {
    thrown.expect(AssertionError.class, "My custom message");
    new StringAssert("hello").as("A Test").overridingErrorMessage("My custom message").doesNotContain("he");
  }
