...
/**
 * Tests for {@link CharAssert#isGreaterThan(char)}.
 *
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
 */
public class CharAssert_isGreaterThan_Test implements Assert_isGreaterThan_TestCase {
  @Rule
  ...
  public void should_fail_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "actual value:<a> should be greater than:<a>");
    new CharAssert('a').isGreaterThan('a');
  }
  ...
  public void should_fail_and_display_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "[A Test] actual value:<a> should be greater than:<a>");
  ...
  public void should_fail_with_custom_message_if_actual_is_equal_to_expected() {
    ...
    new CharAssert('a').overridingErrorMessage("My custom message").isGreaterThan('a');
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new CharAssert('a').as("A Test").overridingErrorMessage("My custom message").isGreaterThan('a');
  }
