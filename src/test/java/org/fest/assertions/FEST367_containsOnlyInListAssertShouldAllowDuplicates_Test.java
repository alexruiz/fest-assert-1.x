...
public class FEST367_containsOnlyInListAssertShouldAllowDuplicates_Test {
  ...
  @Test public void should_pass_if_actual_contains_only_given_values_and_actual_has_duplicates() {
    List<String> list = list("Gandalf", "Sam", "Frodo", "Sam");
    new ListAssert(list).containsOnly("Gandalf", "Frodo", "Sam");
  }

  @Test public void should_pass_if_actual_contains_only_given_values_and_expected_has_duplicates() {
    List<String> list = list("Gandalf", "Sam", "Frodo");
    new ListAssert(list).containsOnly("Gandalf", "Sam", "Frodo", "Sam");
  }

  @Test public void should_pass_if_actual_contains_only_given_values_and_both_have_duplicates() {
