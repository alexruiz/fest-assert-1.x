 ...
 * @author Alex Ruiz
 */
public class CharAssert_isNotEqualTo_Character_Test extends GenericAssert_isNotEqualTo_TestCase<CharAssert, Character> {
  ...
  @Override protected Character notEqualValue() {
    return unequalValue;
  }
}
