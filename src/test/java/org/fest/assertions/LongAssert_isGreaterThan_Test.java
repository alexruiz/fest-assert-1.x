...
public class LongAssert_isGreaterThan_Test implements Assert_isGreaterThan_TestCase {
  ...
  public void should_fail_with_custom_message_if_actual_is_equal_to_expected() {
    ...
    new LongAssert(6).overridingErrorMessage("My custom message").isGreaterThan(6);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new LongAssert(6).as("A Test").overridingErrorMessage("My custom message").isGreaterThan(6);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new LongAssert(6).overridingErrorMessage("My custom message").isGreaterThan(10);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new LongAssert(6).as("A Test").overridingErrorMessage("My custom message").isGreaterThan(10);
  }
}
