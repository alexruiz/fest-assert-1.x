...
/**
 * Tests for <code>{@link PrettyPrintIterator}</code>.
 *
 * @author Alex Ruiz
 */
public class PrettyPrintIterator_Iterator_Test {
  ...
  @Test public void should_delegate_to_Iterator() {
  ...
  @Test public void should_throw_error_on_remove() {
    thrown.expect(UnsupportedOperationException.class);
    iterator.remove();
  }

  @Test public void should_show_contents_in_toString() {
