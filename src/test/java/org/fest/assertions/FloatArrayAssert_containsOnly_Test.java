...
public class FloatArrayAssert_containsOnly_Test implements GroupAssert_containsOnly_TestCase {
  ...
  @Test public void should_fail_if_actual_is_empty_and_expecting_at_least_one_element() {
    thrown.expectAssertionError("<[]> does not contain element(s):<[7.0]>");
  ...
  @Test public void should_fail_and_display_description_if_actual_is_empty_and_expecting_at_least_one_element() {
    thrown.expectAssertionError("[A Test] <[]> does not contain element(s):<[7.0]>");
    new FloatArrayAssert(emptyFloatArray()).as("A Test")
                                           .containsOnly(7f);
  }
  ...
  @Test public void should_fail_if_actual_contains_unexpected_values() {
    thrown.expectAssertionError("unexpected element(s):<[6.0]> in <[8.0, 6.0]>");
  ...
  @Test public void should_fail_and_display_description_if_actual_contains_unexpected_values() {
    thrown.expectAssertionError("[A Test] unexpected element(s):<[6.0]> in <[8.0, 6.0]>");
  ...
  @Test public void should_fail_if_actual_does_not_contain_all_the_expected_values() {
    thrown.expectAssertionError("<[8.0, 6.0]> does not contain element(s):<[7.0]>");
  ...
  @Test public void should_fail_and_display_description_if_actual_does_not_contain_all_the_expected_values() {
    thrown.expectAssertionError("[A Test] <[8.0, 6.0]> does not contain element(s):<[7.0]>");
    new FloatArrayAssert(array).as("A Test")
                               .containsOnly(7f);
  }
