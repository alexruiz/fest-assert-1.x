...
/**
 * Test for {@link DoubleAssert#isPositive()}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
 */
public class DoubleAssert_isPositive_Test implements NumberAssert_isPositive_TestCase {
  @Rule
  ...
  public void should_fail_with_custom_message_if_actual_is_negative() {
    ...
    new DoubleAssert(-6.68).overridingErrorMessage("My custom message").isPositive();
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_negative() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(-6.68).as("A Test").overridingErrorMessage("My custom message").isPositive();
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(0.0).overridingErrorMessage("My custom message").isPositive();
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_zero() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(0.0).as("A Test").overridingErrorMessage("My custom message").isPositive();
  }
}