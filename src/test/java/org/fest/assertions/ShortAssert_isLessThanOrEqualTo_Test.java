...
/**
 * Tests for {@link ShortAssert#isLessThanOrEqualTo(short)}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
...
public class ShortAssert_isLessThanOrEqualTo_Test implements Assert_isLessThanOrEqualTo_Test {
  ...
  public void should_fail_and_display_description_if_actual_is_greater_than_expected() {
    ...
    new ShortAssert(actual).as("A Test").isLessThanOrEqualTo(lessThanActual);
  }
  ...
  public void should_fail_with_custom_message_if_actual_is_greater_than_expected() {
    ...
    new ShortAssert(actual).overridingErrorMessage("My custom message").isLessThanOrEqualTo(lessThanActual);
  }
