...
public class LongAssert_isPositive_Test implements NumberAssert_isPositive_TestCase {
  ...
  @Test public void should_fail_if_actual_is_negative() {
    thrown.expectAssertionError("actual value:<-2> should be greater than:<0>");
    new LongAssert(-2).isPositive();
  }

  @Test public void should_fail_and_display_description_if_actual_is_negative() {
    thrown.expectAssertionError("[A Test] actual value:<-2> should be greater than:<0>");
    new LongAssert(-2).as("A Test")
                      .isPositive();
  }

  @Test public void should_fail_with_custom_message_if_actual_is_negative() {
    thrown.expectAssertionError("My custom message");
    new LongAssert(-2).overridingErrorMessage("My custom message")
                      .isPositive();
  }
