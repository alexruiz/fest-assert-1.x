...
public class FileAssert_exists_Test extends FileAssert_TestCase {
  ...
  @Test public void should_fail_if_actual_does_not_exist() {
    thrown.expectAssertionError("file:<c:\\f.txt> should exist");
    new FileAssert(file).exists();
  }

  @Test public void should_fail_and_display_description_if_actual_does_not_exist() {
    thrown.expectAssertionError("[A Test] file:<c:\\f.txt> should exist");
    new FileAssert(file).as("A Test")
                        .exists();
  }

  @Test public void should_fail_with_custom_message_if_actual_does_not_exist() {
    thrown.expectAssertionError("My custom message");
    new FileAssert(file).overridingErrorMessage("My custom message")
                        .exists();
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_exist() {
    thrown.expectAssertionError("My custom message");
    new FileAssert(file).as("A Test")
