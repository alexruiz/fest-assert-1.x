...
public class MapAssert_includes_Test {
  ...
  @Test public void should_pass_if_actual_contains_entry() {
    new MapAssert(map).includes(entry("key1", 1));
  }

  @Test public void should_pass_if_actual_contains_entries() {
  ...
  @Test public void should_fail_if_actual_does_not_include_entry() {
    thrown.expectAssertionError("the map:<{'key1'=1, 'key2'=2}> does not contain the entry:<['key6'=6]>");
    new MapAssert(map).includes(entry("key6", 6));
  }

  @Test public void should_fail_and_display_description_if_actual_does_not_include_entry() {
  ...
  @Test public void should_fail_with_custom_message_if_actual_does_not_include_entry() {
    thrown.expectAssertionError("My custom message");
    new MapAssert(map).overridingErrorMessage("My custom message")
                      .includes(entry("key6", 6));
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_include_entry() {
    thrown.expectAssertionError("My custom message");
    new MapAssert(map).as("A Test")
  ...
  @Test public void should_fail_if_actual_does_not_include_entries() {
  ...
  @Test public void should_fail_and_display_description_if_actual_does_not_include_entries() {
  ...
  @Test public void should_fail_with_custom_message_if_actual_does_not_include_entries() {
    thrown.expectAssertionError("My custom message");
    new MapAssert(map).overridingErrorMessage("My custom message")
                      .includes(entry("key6", 6), entry("key8", 8));
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_actual_does_not_include_entries() {
    thrown.expectAssertionError("My custom message");
    new MapAssert(map).as("A Test")
                      .overridingErrorMessage("My custom message")
                      .includes(entry("key6", 6), entry("key8", 8));
  ...
  @Test public void should_fail_if_entry_contains_existing_value_but_not_existing_key() {
    thrown.expectAssertionError("the map:<{'key1'=1, 'key2'=2}> does not contain the entry:<['key1'=6]>");
    new MapAssert(map).includes(entry("key1", 6));
  }

  @Test public void should_fail_and_display_description_if_entry_contains_existing_value_but_not_existing_key() {
  ...
  @Test public void should_fail_with_custom_message_if_entry_contains_existing_value_but_not_existing_key() {
    thrown.expectAssertionError("My custom message");
    new MapAssert(map).overridingErrorMessage("My custom message")
                      .includes(entry("key1", 6));
  }

  @Test public void should_fail_with_custom_message_ignoring_description_if_entry_contains_existing_value_but_not_existing_key() {
    thrown.expectAssertionError("My custom message");
    new MapAssert(map).as("A Test")
                      .overridingErrorMessage("My custom message")
                      .includes(entry("key1", 6));
