...
/**
 * Test for {@link DoubleAssert#isNotEqualTo(double)}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
...
public class DoubleAssert_isNotEqualTo_Test implements Assert_isNotEqualTo_TestCase {
  ...
  public void should_fail_and_display_description_if_actual_and_expected_are_equal() {
    ...
    assertObject.as("A Test").isNotEqualTo(actual.doubleValue());
  }
  ...
  public void should_fail_with_custom_message_if_actual_and_expected_are_equal() {
    ...
    assertObject.overridingErrorMessage("My custom message").isNotEqualTo(actual.doubleValue());
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_and_expected_are_equal() {
    thrown.expect(AssertionError.class, "My custom message");
    assertObject.as("A Test").overridingErrorMessage("My custom message").isNotEqualTo(actual.doubleValue());
  }
}
