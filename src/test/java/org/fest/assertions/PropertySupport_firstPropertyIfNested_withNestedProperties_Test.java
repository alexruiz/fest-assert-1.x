...
public class PropertySupport_firstPropertyIfNested_withNestedProperties_Test {
  ...
  public PropertySupport_firstPropertyIfNested_withNestedProperties_Test(
      String nestedPropertyName, String firstProperty) {
  ...
  public void should_return_first_property_name() {
    assertEquals(firstProperty, PropertySupport.instance().firstPropertyIfNested(nestedPropertyName));
  }
}
