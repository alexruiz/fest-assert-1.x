...
/**
 * Test for {@link DoubleAssert#isGreaterThanOrEqualTo(double)}.
 * 
 * @author Yvonne Wang
 * @author David DIDIER
 * @author Alex Ruiz
...
public class DoubleAssert_isGreaterThanOrEqualTo_Test implements Assert_isGreaterThanOrEqualTo_TestCase {
  ...
  public void should_fail_with_custom_message_if_actual_is_less_than_expected() {
    ...
    new DoubleAssert(6.6).overridingErrorMessage("My custom message").isGreaterThanOrEqualTo(8.8);
  }
  ...
  public void should_fail_with_custom_message_ignoring_description_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class, "My custom message");
    new DoubleAssert(6.6).as("A Test").overridingErrorMessage("My custom message").isGreaterThanOrEqualTo(8.8);
  }
}